% script <a href="matlab:PolyPowerTest">PolyPowerTest</a>
...
disp('Compute powers of the polynomial p'); 
p=[1 2], p2=PolyPower(p,2), p3=PolyPower(p,3), disp(' ')

% end script PolyPowerTest